    ...
    const touchbar = {
        ...
        brush: new electron.TouchBar({
            items: [
                new electron.TouchBar.TouchBarSpacer({ size: "flexible" }),
                new electron.TouchBar.TouchBarButton({
                    label: "Prev. Foreground",
                    click() {
                        win.send("previous_foreground_color");
                    },
                }),
                new electron.TouchBar.TouchBarButton({
                    label: "Next Foreground",
                    click() {
...
electron.ipcMain.on("show_editing_touchbar", (event, { id }) =>
    touchbars[id].win.setTouchBar(touchbars[id].touchbar.editing)
);
electron.ipcMain.on("show_selection_touchbar", (event, { id }) =>
    touchbars[id].win.setTouchBar(touchbars[id].touchbar.selection)
);
electron.ipcMain.on("show_operation_touchbar", (event, { id }) =>
    touchbars[id].win.setTouchBar(touchbars[id].touchbar.operation)
);
electron.ipcMain.on("show_brush_touchbar", (event, { id }) =>
    touchbars[id].win.setTouchBar(touchbars[id].touchbar.brush)
);
electron.ipcMain.on("show_reference_touchbar", (event, { id }) =>
    touchbars[id].win.setTouchBar(touchbars[id].touchbar.reference)
);
