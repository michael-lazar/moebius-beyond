...
const palette_4bit_ansi_mapping = {
    ...
    4: 1,
    9: 12,
    12: 9, // flip blue with red
    3: 6,
    6: 3,
    11: 14,
    14: 11, // flip cyan with yellow
};
...
module.exports = {
    ...
    lospec_palette(palette_name) {
        switch (palette_name) {
            ...
            case "link awakening : links colour":
                return [
                    "10ad42",
                    "008000",
                    "004000",
            ...
            case "The Perfect Palette pocket":
                return [
                    "ff97ce",
                    "f32341",
                    "7e2550",
            ...
            case "ANDREW KENSLER 16 (STYLIZED)":
                return [
                    "220826",
                    "ffffff",
                    "f8a04b",
            ...
            case "Campbell (New Windows Console)":
                return [
                    "0c0c0c",
                    "0037da",
                    "13a10e",
            ...
            case "Chip's Challenge Amiga/Atari ST":
                return [
                    "ffffff",
                    "ddddff",
                    "9999dd",
            ...
            case "Sierra Adventures Atari ST":
                return [
                    "e0e0e0",
                    "a0a0a0",
                    "404040",
            ...
            case "JMP (Japanese Machine Palette)":
                return [
                    "000000",
                    "191028",
                    "46af45",
    ...
    xbin_to_rgb(r, g, b) {
        return {
            r: convert_6_to_8bits(r),
            g: convert_6_to_8bits(g),
            b: convert_6_to_8bits(b),
        };
    },
