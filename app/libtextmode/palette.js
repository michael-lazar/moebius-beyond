...
const white = palette_4bit[7];
const bright_white = palette_4bit[15];
...
/**
 * @param {App.Color} rgb1
 * @param {App.Color} rgb2
 * @returns {number}
 */
 ...
 * @returns {number}
 */
function base_palette_index({ r, g, b }) {
 ...
 * @returns {number}
 */
function rgb_to_ansi(rgb, bit_depth = 4) {
    const { r, g, b } = rgb;
    const f = Math.floor;
