...
function edit_menu_template(win) {
    return {
        ...
        submenu: [
            ...
            { type: "separator" },
            { label: "Insert Row", id: "insert_row", accelerator: "Alt+Shift+Up", click(item) { win.send("insert_row"); }, enabled: true },
            { label: "Delete Row", id: "delete_row", accelerator: "Alt+Shift+Down", click(item) { win.send("delete_row"); }, enabled: true },
            { type: "separator" },
            { label: "Insert Column", id: "insert_column", accelerator: "Alt+Shift+Right", click(item) { win.send("insert_column"); }, enabled: true },
            { label: "Delete Column", id: "delete_column", accelerator: "Alt+Shift+Left", click(item) { win.send("delete_column"); }, enabled: true },
            { type: "separator" },
    ...
    return {
        ...
        submenu: [
            ...
            { label: "Actual Size", id: "actual_size", accelerator: "CmdorCtrl+Alt+0", click(item) { win.send("actual_size"); }, type: "checkbox", checked: false },
            {
                label: "Zoom",
                submenu: [
                    { label: "25%", id: "canvas_zoom_25", click(item) { win.send("set_canvas_zoom", 0.25); } },
                    { label: "50%", id: "canvas_zoom_50", click(item) { win.send("set_canvas_zoom", 0.5); } },
                    { label: "75%", id: "canvas_zoom_75", click(item) { win.send("set_canvas_zoom", 0.75); } },
                    { label: "100%", id: "canvas_zoom_100", click(item) { win.send("set_canvas_zoom", 1.0); } },
                    { label: "150%", id: "canvas_zoom_150", click(item) { win.send("set_canvas_zoom", 1.5); } },
                    { label: "200%", id: "canvas_zoom_200", click(item) { win.send("set_canvas_zoom", 2.0); } },
                    { label: "300%", id: "canvas_zoom_300", click(item) { win.send("set_canvas_zoom", 3.0); } },
                    { label: "400%", id: "canvas_zoom_400", click(item) { win.send("set_canvas_zoom", 4.0); } },
                    { label: "500%", id: "canvas_zoom_500", click(item) { win.send("set_canvas_zoom", 5.0); } },
                ]
            },
