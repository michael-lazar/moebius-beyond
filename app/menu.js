...
function view_menu_template(win) {
    return {
        ...
        submenu: [
            ...
            {
                label: "Show Character Palette",
                id: "show_charlist",
                accelerator: "CmdorCtrl+Alt+L",
                click(item) {
                    win.send("show_charlist", item.checked);
                },
                type: "checkbox",
                checked: true,
            },
            ...
            { type: "separator" },
            {
                ...
                submenu: [
                    ...
                    },
                    {
                        ...
                        id: "petscii_guide",
                        click(item) {
                            win.send("toggle_petscii_guide", item.checked);
                        },
                        type: "checkbox",
                        checked: false,
                    },
...
function font_menu_template(win) {
    return {
        ...
        submenu: [
            ...
            {
                label: "Viler's VGA textmode fonts",
                submenu: viler_font_menu_items(win),
            },
            {
...
function colors_menu_template(win) {
    return {
        ...
        submenu: [
            {
                label: "Load Lospec Palette",
                submenu: lospec_palette_menu_items(win),
            },
            {
            ...
            { type: "separator" },
            {
                label: "Use iCE Colors (stop blinking)",
                id: "ice_colors",
...
function create_menu_template(win, debug) {
    const menu_lists = [
        ...
        edit_menu_template(win),
        selection_menu_template(win),
        colors_menu_template(win),
        font_menu_template(win),
